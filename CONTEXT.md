...
- PASCA: med_schedule nevie alternujúce vzory. Vitamín D3K2 sa dáva každý druhý deň (párny dátum) a je uložený ako days="parny_datum" — hodnota, ktorú UI nepozná. Riadok id23 sa NESMIE editovať cez /meds, getDaysValue by ho ticho prepísal na kazdy_den. Meniť len priamo v DB, kým sa model režimu nerozšíri o alternujúce vzory
